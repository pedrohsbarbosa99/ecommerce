...
type BrandValueProps = 'installments' | 'payment_methods' | 'security' | 'payment_methods_logos' | 'credits';
...
type BrandBackgroundColor = 'white' | 'mercado_pago_primary' | 'mercado_pago_secondary' | 'black' | 'transparent';
